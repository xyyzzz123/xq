...
if __name__ == '__main__':
    ...
    # str = "36"
    # t = int(str)
    # print((datetime.datetime.now() - datetime.timedelta(minutes=t)).strftime("%Y-%m-%d %H:%M"))



    # a = time.mktime(time.strptime(valid_date(a), '%Y-%m-%d %H:%M'))
    # b = "2018-01-10 12:32"
    # b = time.mktime(time.strptime(b, '%Y-%m-%d %H:%M'))
    # print(b - a)

    # t = 1501123624000
    # t = time.strftime("%Y-%m-%d %H:%M", time.localtime(int(t / 1000)))
    # print(t)
